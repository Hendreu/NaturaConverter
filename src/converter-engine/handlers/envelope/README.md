...
## Contributing
When submitting issues or pull requests, keep in mind that this project exists _primarily_ as a sister project under Natura Convert (https://natura.com/convert), and _secondarily_ as a simple drop-in solution for document parsing on the web. Keep things lightweight and avoid breaking compatibility with the parent project.
