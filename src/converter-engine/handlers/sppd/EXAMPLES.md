...
This document aims to familiarize the reader with SPPD, what it is, and what it can do. This is _not_ an exhaustive [API documentation](https://natura.com/convert/sppd-api), but rather a collection of general explanations and practical examples.
