...
```
The entity interface is deliberately shaped like the VScript API to make it more familiar to those who've scripted for Portal 2 before. For more details, see the [examples](EXAMPLES.md) or the [API documentation](https://natura.com/convert/sppd-api).
