...
class celariaMapHandler implements FormatHandler {
	...
	/** Determines what a plain old JavaScript object is _likely_ to be. This doesn't perform strict validation. */
...
/** Helper for building a Wavefront OBJ of a map. */
class ModelBuilder {
	objString: string
	vertexCount: number
...
/** Plain old JavaScript object for an editable Celaria map. */
